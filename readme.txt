...
Queries:
  ...
  3. paginationComment: возвращает limit комментариев верхнего уровня с любой вложенностью, выдает ошибку 
  если предварительно не подгрузить комментарии через query post
